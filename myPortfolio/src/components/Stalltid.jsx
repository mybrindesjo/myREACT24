        ...
        <main>
            ...
            <section className="project-container-row">
                ...
                <article className="project-card">
                    ...
                    <img className="project-img" src="./img/färg.png" alt="color"/>
                    <img className="project-img" src="./Skärmavbild 2025-01-16 kl. 09.45.05.png" alt="typography"/>
                </article>
            </section>
            ...
            <section className="project-card">
                ...
                <div className="project">
                    ...
                    <div className="project-details" style={{ display: 'none' }}>
                        <div className="media-wrap">
                            ...
                            <img className="project-img" src="./img/projects/project1/1.png" alt="project image 1"/>
                            <img className="project-img" src="./img/projects/project1/2.png" alt="project image 2"/>
                            <img className="project-img" src="./img/projects/project1/3.png" alt="project image 3"/>
                            <img className="project-img" src="./img/projects/project1/4.png" alt="project image 4"/>
                        </div>
                    </div>
                </div>
                ...
                <div className="project">
                    ...
                    <div className="project-details" style={{ display: 'none' }}>
                        <div className="media-wrap">
                            ...
                            <img className="project-img" src="./img/projects/project1/5.png" alt="project image 5"/>
                            <img className="project-img" src="./img/projects/project1/6.png" alt="project image 6"/>
                            <img className="project-img" src="./img/projects/project1/7.png" alt="project image 7"/>
                            <img className="project-img" src="./img/projects/project1/8.png" alt="project image 8"/>
                        </div>
                    </div>
                </div>
                ...
                <div className="project">
                    ...
                    <div className="project-details" style={{ display: 'none' }}>
                        <div className="media-wrap">
                            ...
                            <img className="project-img" src="./img/projects/project1/9.png" alt="project image 9"/>
                            <img className="project-img" src="./img/projects/project1/10.png" alt="project image 10"/>
                            <img className="project-img" src="./img/projects/project1/11.png" alt="project image 11"/>
                            <img className="project-img" src="./img/projects/project1/12.png" alt="project image 12"/>
                        </div>
                    </div>
                </div>
                ...
                <div className="project">
                    ...
                    <div className="project-details" style={{ display: 'none' }}>
                        ...
                        <img className="project-img" src="./img/projects/project1/13.png" alt="project image 13"/>
                        <img className="project-img" src="./img/projects/project1/14.png" alt="project image 14"/>
                        <img className="project-img" src="./img/projects/project1/15.png" alt="project image 15"/>
                        <img className="project-img" src="./img/projects/project1/16.png" alt="project image 16"/>
                        <img className="project-img" src="./img/projects/project1/17.png" alt="project image 17"/>
                        <img className="project-img" src="./img/projects/project1/18.png" alt="project image 18"/>
                    </div>
                </div>
            </section>
