            ...
            <section className="project-container-row">
                <article className="project-card">
                    <div className="project-header">
                        ...
                        <img className="project-img" src="/myportfolio/img/skissmobile.png" alt="mobile"/>
                        <img className="project-img" src="/myportfolio/img/skissdesktop.png" alt="desktop"/>
                </article>
                ...
                <article className="project-card">
                    <div className="project-header">
                        ...
                        <img className="project-img" src="/myportfolio/img/color.png" alt="color"/>
                        <img className="project-img" src="/myportfolio/img/typescript.png" alt="typography"/>
                </article>
            </section>
                    ...
                    <div className="project-header">
                        ...
                        <div className="project-details" style="display: none;">
                            <div className="media-wrap">
                                ...
                                <button className="project-btn">
                                    ...
                                    <img className="project-img" src="/myportfolio/img/projects/project1/1.png" alt=""/>
                                    <img className="project-img" src="/myportfolio/img/projects/project1/2.png" alt=""/>
                                    <img className="project-img" src="/myportfolio/img/projects/project1/3.png" alt=""/>
                                    <img className="project-img" src="/myportfolio/img/projects/project1/4.png" alt=""/>
                            </div>
                        ...
                        <div className="project-details" style="display: none;">
                            <div className="media-wrap">
                                ...
                                <img className="project-img" src="/myportfolio/img/projects/project1/5.png" alt=""/>
                                <img className="project-img" src="/myportfolio/img/projects/project1/6.png" alt=""/>
                                <img className="project-img" src="/myportfolio/img/projects/project1/7.png" alt=""/>
                                <img className="project-img" src="/myportfolio/img/projects/project1/8.png" alt=""/>
                            </div>
                        </div>
                        ...
                        <div className="project-details" style="display: none;">
                            <div className="media-wrap">
                                ...
                                <img className="project-img" src="/myportfolio/img/projects/project1/9.png" alt=""/>
                                <img className="project-img" src="/myportfolio/img/projects/project1/10.png" alt=""/>
                                <img className="project-img" src="/myportfolio/img/projects/project1/11.png" alt=""/>
                                <img className="project-img" src="/myportfolio/img/projects/project1/12.png" alt=""/>
                            </div>
                        </div>
                        ...
                        <div className="project-details" style="display: none;">
                            ...
                            <img className="project-img" src="/myportfolio/img/projects/project1/13.png" alt=""/>
                            <img className="project-img" src="/myportfolio/img/projects/project1/14.png" alt=""/>
                            <img className="project-img" src="/myportfolio/img/projects/project1/15.png" alt=""/>
                            <img className="project-img" src="/myportfolio/img/projects/project1/16.png" alt=""/>
                            <img className="project-img" src="/myportfolio/img/projects/project1/17.png" alt=""/>
                            <img className="project-img" src="/myportfolio/img/projects/project1/18.png" alt=""/>
                        </div>
                        </div>
                    </div>
