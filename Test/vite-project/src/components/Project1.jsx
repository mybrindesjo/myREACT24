    ...
    <main>
      ...
      <section className="project-container-row">
        ...
        <article className="project-card">
          <div className="project-header">
            ...
            <img className="project-img" src="./img/typography.png" alt="typography" />
        </article>
      </section>
      ...
      <section className="project-card">
        ...
        <div className="project">
          <div className="row">
            <h3>Vit/Blå</h3>
            <button className="toggle-btn" onClick={() => toggleSection('vitBla')}>{openSections.vitBla ? '-' : '+'}</button>
          </div>
          <div className="project-details" style={{ display: openSections.vitBla ? 'block' : 'none' }}>
        ...
        <div className="project">
          <div className="row">
            ...
            <button className="toggle-btn" onClick={() => toggleSection('gronGulBeige')}>{openSections.gronGulBeige ? '-' : '+'}</button>
          </div>
          <div className="project-details" style={{ display: openSections.gronGulBeige ? 'block' : 'none' }}>
            <div className="media-wrap">
        ...
        <div className="project">
          <div className="row">
            <h3>Grön/Gul</h3>
            <button className="toggle-btn" onClick={() => toggleSection('gronGul')}>{openSections.gronGul ? '-' : '+'}</button>
          </div>
          <div className="project-details" style={{ display: openSections.gronGul ? 'block' : 'none' }}>
            <div className="media-wrap">
        ...
        <div className="project">
          <div className="row">
            ...
            <button className="toggle-btn" onClick={() => toggleSection('slutgiltligDesign')}>{openSections.slutgiltligDesign ? '-' : '+'}</button>
          </div>
          <div className="project-details" style={{ display: openSections.slutgiltligDesign ? 'block' : 'none' }}>
            <button className="project-btn">
